...
<body class="">
    ...
    <nav class="pushy pushy-left">
        <ul class="list-unstyled">
            ...
            <li><a href="http://www.themeinthebox.com/ourtheme/mountain-king-bootstrap-template/"
        ...
        <div class="container-fluid">
            ...
            <div class="container">
                ...
                <div class="jumbotron">
                    ...
                    <p><a class="btn btn-primary btn-lg" role="button">Learn more</a> <a target="_blank"
                            href="http://www.themeinthebox.com/ourtheme/mountain-king-bootstrap-template/"
                            class="btn btn-lg btn-danger" role="button">Download</a></p>
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            <div class="row features">
                ...
                <div class="col-md-4 text-center wow fadeInUp" data-wow-delay="500ms">
                    ...
                    <p>Etiam porta sem malesuada magna mollis euismod. Aenean eu leo quam. Pellentesque ornare sem
                        lacinia quam venenatis vestibulum. Maecenas faucibus mollis interdum.</p>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="row">
                    <div class="col-md-6 opaline col-md-offset-6">
                        ...
                        <div class="row text-center">
                            ...
                            <div
                                class="col-md-4 boxes col-xs-6 col-xs-offset-3 col-lg-4 col-lg-offset-1 col-md-offset-1 col-sm-6 wow fadeInUp">
                                <h5>Ultricies</h5>
            ...
            <div class="row">
                <div class="col-md-7">
                    ...
                    <p>Donec id elit non mi porta gravida at eget metus. Donec id elit non mi porta gravida at eget
                        ...
                        pharetra augue.</p>
                    <a class="btn btn-danger btn-lg" href="#">Take a Look <i class="fa fa-arrow-circle-o-right"></i>
                    </a>
                </div>
                <div class="col-md-5">
                    <a href="#">
                        ...
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1">
                                ...
                                <p><i>Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum.
                                        ...
                                        odio sem nec elit. Aenean eu leo quam. Pellentesque ornare sem lacinia quam
                                        venenatis vestibulum. Cras justo odio, dapibus ac facilisis in, egestas eget
                                        quam. Praesent commodo cursus magna, vel scelerisque nisl consectetur et.</i>
                                </p>
    ...
    <section class="clients wow fadeInUp" data-wow-delay="300ms">
        <div class="container">
            <div class="row">
                <div class="col-md-2">
                    <img src="{{ asset('images/logo-sample-01.jpg')}}" class="img-responsive" />
                </div>
                <div class="col-md-2">
                    <img src="{{ asset('images/logo-sample-02.jpg')}}" class="img-responsive" />
                </div>
                <div class="col-md-2">
                    <img src="{{ asset('images/logo-sample-03.png')}}" class="img-responsive" />
                </div>
                <div class="col-md-2">
                    <img src="{{ asset('images/logo-sample-04.jpg')}}" class="img-responsive" />
                </div>
                <div class="col-md-2">
                    <img src="{{ asset('images/logo-sample-05.jpg')}}" class="img-responsive" />
                </div>
                <div class="col-md-2">
                    <img src="{{ asset('images/logo-sample-06.png')}}" class="img-responsive" />
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <p>Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum. Cras mattis
                            consectetur purus sit amet fermentum. Praesent commodo cursus magna, vel scelerisque nisl
                            consectetur et. Praesent commodo cursus magna, vel scelerisque nisl consectetur et.</p>
                        <div class="row">
                            <div class="col-md-6">
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <h3>Your Logo</h3>
                    <p>© 2016 Your Company. Designed and Developed by <a target="_blank"
                            href="http://www.themeinthebox.com">ThemeintheBox.com</a></p>
                </div>
                <div class="col-md-4">
